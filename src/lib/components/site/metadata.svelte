<script lang="ts">
  ...
  type Props = {
    ...
    locale?: string;
    /**
     * Specifies the web app manifest file path.
     * If provided, adds a manifest link tag to the document head.
     */
    manifest?: string;
    /**
...
<svelte:head>
  ...
  <meta
    property="og:type"
    content={type || (og_article ? "article" : "website")}
  />
  ...
  {#if og_image}
    ...
    {#if og_image.urlSecure}
      <meta
        ...
        content={safe_local_url(og_image.urlSecure)}
      />
    {/if}
  ...
  {#if og_article}
    <meta
      ...
      content={og_article.published_time}
    />
    {#if og_article.modified_time}
      <meta
        property="article:modified_time"
        content={og_article.modified_time}
      />
    {/if}
    {#if og_article.expiration_time}
      <meta
        property="article:expiration_time"
        content={og_article.expiration_time}
      />
    {/if}
